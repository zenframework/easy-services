...
public class FilterContext implements Context {
    ...
    protected final NameParser parser;
    protected final Name contextName;

    public FilterContext(Context context) throws NamingException {
        this.context = context;
        parser = context.getNameParser(context.getNameInNamespace());
        contextName = parser.parse(context.getNameInNamespace());
    }
