...
// Loads required modules from Java classpath
function require(url) {
	...
	if (!exports) { // not cached
		exports = {};
		var source = org.zenframework.easyservices.js.junit.Loader.readFromClasspath('/export/', url);
		...
		source = '//# sourceURL=classpath://' + source;
